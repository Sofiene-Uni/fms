...
class Swt():
    ...
    def __str__(self):
        return "Shortest Waiting Time (SWT): Prioritize jobs with the lowest waiting time since last allocation"
    ...
    def decide(self, sim):
        ...
        # Find the index of the job with the minimum waiting time
        job = np.argmin(waiting_times)
